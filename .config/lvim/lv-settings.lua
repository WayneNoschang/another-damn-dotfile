...
lvim.builtin.alpha.dashboard.section.buttons.val["6"].opts.keymap["3"] = "<CMD>edit ~/.config/lvim/config.lua <CR>"
...
lvim.builtin.mason.install_root_dir = "~/.local/share/nvim/mason"
...
lvim.builtin.project.datapath = "~/.cache/lvim"
...
lvim.lsp.nlsp_settings.setup.config_home = "~/.config/lvim/lsp-settings"
lvim.lsp.nlsp_settings.setup.loader = "json"
lvim.lsp.null_ls.setup.debug = false
lvim.lsp.templates_dir = "~/.local/share/lunarvim/site/after/ftplugin"
